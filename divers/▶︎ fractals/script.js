(() => {
  ...
  input.onchange = () => {
    let limit = input.options[input.selectedIndex].value;
    context.clearRect(-width / 2, height / -2, width, height);


    koch(startingPoints.p1, startingPoints.p2, limit);
    koch(startingPoints.p2, startingPoints.p3, limit);
    koch(startingPoints.p3, startingPoints.p1, limit);
  };
})();